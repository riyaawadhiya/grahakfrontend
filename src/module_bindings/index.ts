...
import OrderItemsRow from "./order_items_table";
import OrdersRow from "./orders_table";
...
const tablesSchema = __schema({
  order_items: __table({
    name: 'order_items',
    indexes: [
      { accessor: 'id', name: 'order_items_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'order_items_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, OrderItemsRow),
  orders: __table({
    name: 'orders',
    indexes: [
      { accessor: 'id', name: 'orders_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'orders_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, OrdersRow),
  products: __table({
    name: 'products',
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("get_queue_position", GetQueuePositionReducer),
  __reducerSchema("register_device", RegisterDeviceReducer),
  __reducerSchema("update_order_status", UpdateOrderStatusReducer),
  __reducerSchema("verify_and_place_order", VerifyAndPlaceOrderReducer),
);
