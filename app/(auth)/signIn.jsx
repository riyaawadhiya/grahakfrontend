...
export default function Signin() {
  ...
  return (
    <SafeAreaView className="flex-1 justify-center px-6 bg-black">
      <Text className="text-3xl text-white mb-6">Sign In</Text>
      ...
      <ScrollView contentContainerClassName="flex-grow justify-center px-6 py-12" keyboardShouldPersistTaps="handled">
        ...
        <View className="gap-y-5">
          ...
          <View>
            ...
            <View
              className={`flex-row items-center rounded-2xl border bg-slate-900/50 px-4 py-4 ${isEmailFocused ? 'border-indigo-500' : 'border-slate-800'
                }`}
            >
          ...
          <View>
            ...
            <View
              className={`flex-row items-center rounded-2xl border bg-slate-900/50 px-4 py-4 ${isPasswordFocused ? 'border-indigo-500' : 'border-slate-800'
                }`}
            >
          ...
          <View className="mt-2 flex-row items-center justify-between">
            ...
            >
              <View
                className={`mr-3 h-6 w-6 items-center justify-center rounded-lg border ${agreedToTerms ? 'border-indigo-500 bg-indigo-500' : 'border-slate-600 bg-slate-800'
                  }`}
              >
